...
const Home = () => {
  return (
    <div className="min-h-[82vh] flex flex-col md:flex-row items-center justify-around text-black w-full">
      ...
      <div className="md:mt-0 flex justify-center">
        <img
          src="/img.jpg"
          alt="Profile"
          className="w-64 h-64 md:w-[90vw] rounded-full object-cover shadow-2xl border-[3px] border-pink-700"
        />
      </div>
    </div>
  );
