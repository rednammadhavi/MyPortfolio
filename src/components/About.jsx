    ...
    <div className="bg-white text-black w-full p-6 flex flex-col items-center">
      ...
      <div className="w-full max-w-7xl p-2">
        ...
        <div className="text-justify space-y-2">
          <h1 className="font-semibold text-sm">Name : <span className="font-normal">Rednam Naga Madhavi</span></h1>
          <h1 className="font-semibold text-sm">Nationality : <span className="font-normal">Indian</span></h1>
          <h1 className="font-semibold text-sm">Location : <span className="font-normal">Kakinada</span></h1>
          <h1 className="font-semibold text-sm">Phone : <span className="font-normal">+91 9100736575</span></h1>
          <h1 className="font-semibold text-sm">Gmail : <span className="font-normal">rednammadhavi@gmail.com</span></h1>
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl p-2">
        ...
        <div className="text-justify space-y-2">
          <div className='flex flex-col py-1'>
            ...
            <h1 className="font-semibold text-sm">Btech (CSE - AI & ML) : <span className="font-normal">Pragati Engineering College, Kakinada</span></h1>
          </div>
          <div className='flex flex-col py-1'>
            <span className='text-sm font-extralight text-pink-900'>2020 - 2022</span>
            <h1 className="font-semibold text-sm">Intermediate : <span className="font-normal">Madhuri Junior College, Gollaprolu</span></h1>
          </div>
          <div className='flex flex-col py-1'>
            <span className='text-sm  font-extralight text-pink-900'>2019 - 2020</span>
            <h1 className="font-semibold text-sm">10th Borad : <span className="font-normal">Madhuri Vidyalaya, Gollaprolu</span></h1>
          </div>
        </div>
      </div>
